...
fn prefix_query_preheater(pq: &PrefixQuery) -> PreHeater {
    ...
    let synth_field: LeanString = format!("__PREFIX{}__{}", plen, pq.field()).into();
...
impl Literal {
    ...
    */
    pub(crate) fn percolate_doc_field_value(&self) -> (LeanString, LeanString) {
        match &self.query {
